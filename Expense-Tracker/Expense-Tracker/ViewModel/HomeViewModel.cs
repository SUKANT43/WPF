...
namespace Expense_Tracker.ViewModel
{
    public class HomeViewModel : Observable
    {
        ...
        {
            get => _fromDate;
            set { _fromDate = value; OnPropertyChanged(); ApplyFilter(); }
        }
        ...
        {
            get => _toDate;
            set { _toDate = value; OnPropertyChanged(); ApplyFilter(); }
        }
        ...
        public Category? SelectedFilterCategory
        {
            ...
            set { _selectedFilterCategory = value; OnPropertyChanged(); ApplyFilter(); }
        }
        ...
        public TransactionType? TransactionTypeFilterCategory
        {
            ...
            set { _transactionTypeFilterCategory = value; OnPropertyChanged(); ApplyFilter(); }
        }
        ...
        {
            get => _numberOfIncome;
            set { _numberOfIncome = value; OnPropertyChanged(); }
        }
        ...
        public int NumberOfExpense
        {
            ...
            set { _numberOfExpense = value; OnPropertyChanged(); }
        }
